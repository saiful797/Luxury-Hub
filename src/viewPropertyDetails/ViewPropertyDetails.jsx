    ...
    return (
        ...
        <div className='md:flex bg-blue-950 rounded-2xl mt-5 text-white'>
                ...
                <div className='md:w-[60%] text-left p-10 space-y-3'>
                    ...
                    <h4 className="text-xl font-thin">Area <span className="text-xl font-bold text-amber-400 hover:text-[#22c1c3]">: {area}</span></h4>
                    ...
                    <div className='flex gap-2'>
                        <h1>Facilities: </h1>
                        <p className='text-green-500 text-lg font-bold'><span className='text-[#fdbb2d]'>#</span>{facilities[0]}</p>
                        <p className='text-green-500 text-lg font-bold'><span className='text-[#fdbb2d]'>#</span>{facilities[1]}</p>
                        <p className='text-green-500 text-lg font-bold'><span className='text-[#fdbb2d]'>#</span>{facilities[2]}</p>
                        <p className='text-green-500 text-lg font-bold'><span className='text-[#fdbb2d]'>#</span>{facilities[3]}</p>
                    </div>
                </div>
            </div>
    );
