...
const About = () => {
    return (
        <div className="max-w-4xl mx-auto">
            ...
            <div className="mt-5 space-y-2 text-lg font-medium text-white border rounded-2xl bg-blue-950 shadow-sm p-5 text-justify">
                <p>
                <span className="text-green-600 text-2xl font-bold">Welcome</span> to<span className="text-[#22c1c3]"> Luxury </span> <span className="text-[#fdbb2d]">Hub </span>, where unparalleled luxury meets exceptional real estate. We are your premier destination for discovering the most exquisite properties around the world, meticulously curated to meet the discerning tastes of our esteemed clientele.
                </p>
